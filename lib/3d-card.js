        ...
        <div className="flex flex-col justify-between py-4">
          <motion.div
            ...
            <motion.p className="mt-8 text-lg text-white dark:text-neutral-300">
              ...
              <p className="flex space-x-4 my-[10px]">
             
              <a href= {testimonials[active]?.gitHubLink} target="_blank" rel="noopener noreferrer">
      <Image className="min-w-[30px] min-h-[30px] max-w-[30px] max-h-[30px]" src="/githubs.png" alt="Clickable Image" width={30} height={30} />
      
    </a>
    <a href= {testimonials[active]?.gitHubLink} target="_blank" rel="noopener noreferrer">GitHub Link </a>
